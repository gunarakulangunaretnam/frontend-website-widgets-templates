                        ...
                        <li class="sf-mega-enable-1">
                            ...
                            <div class="sf-mega template-layout-20x20x20x20x20 template-clear-fix">
                                <div class="template-layout-column-left">
                                    ...
                                    <ul>
                                        <li><a href="4-1-0-peacebuilding.php#sylc">Sagacious Youth Lead Consortium
                                                (SYLC)</a></li>
                                ...
                                <div class="template-layout-column-center-left">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="4-2-0-communities.php#visual-content-makers">Visual Content
                                                Makers</a></li>
                                        <li><a href="4-2-0-communities.php#trashfortrade-community">Trash For Trade
                                                Community</a></li>
                                        <li><a href="4-2-0-communities.php#oceanbiome-community">OceanBiome
                                                Community</a></li>
                                        <li><a href="4-2-0-communities.php#ai-community">AI Community</a></li>
                                        <li><a href="4-2-0-communities.php#makers">Change Makers</a></li>
                                        <li><a href="4-2-0-communities.php#shetechpreneur-community">SheTechpreneur
                                                Community</a></li>
                                    </ul>
                                </div>
